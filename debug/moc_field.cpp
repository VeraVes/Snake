...
QT_MOC_LITERAL(1, 6, 13), // "signalNewGame"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 8), // "setCount"
QT_MOC_LITERAL(4, 30, 11) // "slotNewGame"

    },
    "Field\0signalNewGame\0\0setCount\0slotNewGame"
};
...
void Field::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Field::signalNewGame)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Field::setCount)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Field::signalNewGame()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Field::setCount(int _t1)
{
